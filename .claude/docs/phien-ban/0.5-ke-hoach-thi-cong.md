...
> thật trong `xime/`. Phạm vi & lý do nền tảng xem `0.5-ke-hoach.md` và
...
Kế hoạch gốc (`0.5-ke-hoach.md`) khuyến nghị **audit trước, feature sau**. Chủ dự
...
8 trục soi xuyên suốt (theo `0.5-ke-hoach.md`): mâu thuẫn logic giữa các phần,
...
- Cập nhật `.claude/docs/thiet-ke/02-cay-thu-muc.md`, `../thiet-ke/01-tong-quan.md`,
