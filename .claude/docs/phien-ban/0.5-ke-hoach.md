...
8. **Dọn backlog tồn đọng** - đối chiếu `../kiem-toan/backlog-sua-loi.md`, mục `[ ]` còn mở ở
   `../thiet-ke/08-grpc-client-mtls.md`, TODO rải trong code.
...
- Class-based controller giống `../thiet-ke/04-routing-layer.md`: `_make_handler` đọc decorator,
...
hơn). Fieldbus công nghiệp (Modbus/OPC UA) đã dời sang 0.7 (`0.7-ke-hoach.md`).
