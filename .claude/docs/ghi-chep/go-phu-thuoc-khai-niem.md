...
`../da-phu-dinh/peer-app-id-tu-san-cert.md` mục 4.4:
...
- [`../da-phu-dinh/peer-app-id-tu-san-cert.md`](../da-phu-dinh/peer-app-id-tu-san-cert.md) - thiết kế gốc 0.6.3. **Giữ làm
  lịch sử**, đừng đọc như hiện trạng. Mục 4.4 và 4.5 của nó là chỗ ranh giới bị trượt
- [`phu-thuoc-bac-cau.md`](phu-thuoc-bac-cau.md) - ba
