...
> Chốt **2026-08-18**. Thay hẳn phần Bus của [`ke-hoach-0.8.md`](ke-hoach-0.8.md)
> (bản 2026-06-27), thứ mà buổi 08-16 đã lật phần lớn.
>
> Đây là **thiết kế, chưa có một dòng code nào**. Đo cùng ngày:
> `grep -rn "ProcessLink" xime/` ra rỗng.
...
[đã chốt làm trước](cache-lien-tien-trinh-2026-08-16.md) (*"đa tiến trình trước, đa
luồng để sau"*).
...
Quyết định 2.1 của [`cache-lien-tien-trinh-2026-08-16.md`](cache-lien-tien-trinh-2026-08-16.md)
...
`line-2`. Luật đã chốt ở [`da-tien-trinh-main-va-cau-hinh-2026-08-16.md`](da-tien-trinh-main-va-cau-hinh-2026-08-16.md)
...
6. release semaphore của MỌI tiến trình khác
```
...
> [tài liệu nhóm 2](kho-nhom-2-store-2026-08-19.md) mục 3.7.
...
| **Transport abstraction** (`Redis`/`Tcp`/`UnixSocket`) | phiên | Chủ dự án đã chốt **không chia sẻ bộ nhớ giữa hai máy** và hướng cache nhắm **bỏ Redis**. Giữ một lớp trừu tượng cho một tương lai đã bị loại là chi phí thuần: nó ép mọi API xuống mẫu số chung của các transport không bao giờ tồn tại |
...
Phần lõi đóng hết. Không mục nào chặn việc bắt tay code.

| Chỗ | Ghi chú |
|---|---|
| Chi tiết hiện thực | Phát sinh lúc code, không phải quyết định thiết kế |
...
- [`kho-nhom-1-snapshot-2026-08-18.md`](kho-nhom-1-snapshot-2026-08-18.md) - **kho
...
- [`cache-lien-tien-trinh-2026-08-16.md`](cache-lien-tien-trinh-2026-08-16.md) - kho
  liên tiến trình. Mục **2.1** là quyết định tách bus khỏi kho, thứ định hình toàn bộ
  vai của bus.
- [`ke-hoach-0.8.md`](ke-hoach-0.8.md) - bản 2026-06-27, **phần Bus đã bị file này
