...
> | | |
> |---|---|
> | **Trạng thái** | ⛔ **BỊ PHỦ ĐỊNH** - tính năng đã bị gỡ khỏi framework |
> | **Từng có ở** | 0.6.3 (2026-07-27) |
> | **Bị gỡ ở** | 0.7.1 (2026-08-17) |
> | **Đọc thay** | [`../ghi-chep/go-phu-thuoc-khai-niem.md`](../ghi-chep/go-phu-thuoc-khai-niem.md) |
...
> Hiện trạng + lý do:
> [`../ghi-chep/go-phu-thuoc-khai-niem.md`](../ghi-chep/go-phu-thuoc-khai-niem.md).
>
...
- Wishlist gốc: [`../sap-toi/wishlist-tinh-nang.md`](../sap-toi/wishlist-tinh-nang.md), mục "Trích thêm SAN
