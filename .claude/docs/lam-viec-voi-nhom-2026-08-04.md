...
| # | Việc | Vì sao |
|---|---|---|
| 1 | Đọc [`vuong-mac-scheduler-trong-test-2026-08-04.md`](vuong-mac-scheduler-trong-test-2026-08-04.md) | Việc cụ thể duy nhất đang chờ bạn. ⚠ Đọc **mục 5** trước khi ước lượng - phạm vi hẹp hơn tiêu đề |
...
|---|---|
| [`rules/01`](file:///D:/code/xime/.claude/rules/01-song-song-hoa-va-shard.md) song song hoá & shard | Framework **không có bảng**, nên nghĩa 2 không áp. Nhưng nghĩa 1 thì có - và **framework là nơi quyết định các repo khác vi phạm dễ đến đâu** |
| [`rules/03`](file:///D:/code/xime/.claude/rules/03-mot-gia-tri-mot-nghia.md) một giá trị một nghĩa | **Áp mạnh nhất ở đây.** API của bạn là hợp đồng với 30 codebase. Bốn mặc định không an toàn của framework từng **im lặng** (gRPC plaintext, OPC UA None, MQTT không TLS, WebSocket không qua xác thực) - đó là giá trị mang hai nghĩa ở mức mặc định |
...
Đọc [`04-chin-khuon-loi-lap-lai.md`](file:///D:/code/xime/.claude/dieu-phoi/04-chin-khuon-loi-lap-lai.md) khi bạn định báo "xong". Bảng rút gọn:
...
Nhật ký ngày đầy đủ: [`06-nhat-ky-2026-08-04.md`](file:///D:/code/xime/.claude/dieu-phoi/06-nhat-ky-2026-08-04.md).
