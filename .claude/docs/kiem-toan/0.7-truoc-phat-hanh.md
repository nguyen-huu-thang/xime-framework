...
## Tóm tắt (chuyển từ CLAUDE.md)

> Chuyển từ `.claude/CLAUDE.md` ngày 2026-08-21. Đây là bản rút gọn của chính đợt kiểm
> toán mô tả trong file này, kèm hai quyết định của chủ dự án ngày 2026-07-30.


**Hoàn tất 2026-07-30. Mọi phát hiện đã vá, không còn mục nào mở.**
Báo cáo đầy đủ: `docs/kiem-toan/0.7-truoc-phat-hanh.md` (16 phát hiện: 3 Cao, 8 Trung, 5 Thấp).
...
- **`PEER_APP_ID`** (`docs/da-phu-dinh/peer-app-id-tu-san-cert.md`) - mắt xích tiếp theo của đợt
  "hồn - xác" nằm ở **data-service**, không phải repo này.
- **TLS cho web adapter** (`docs/thiet-ke/07-tls-web-adapter.md`) - mức 1 xong, app bật HTTPS
...
lượt**. ⚠ **Thiết kế đổi hẳn 2026-08-16** - `docs/da-phu-dinh/ke-hoach-0.8-ban-dau.md` (bản
2026-06-27) phần lớn không còn dùng; đọc `docs/thiet-ke/10-da-tien-trinh.md`
và `docs/thiet-ke/09-kho-lien-tien-trinh-boi-canh.md`. Bảng việc đầy đủ ở mục "Việc đang
