# Tiến độ thi công - Socket Adapter

> | | |
> |---|---|
> | **Trạng thái** | 📋 **GIẤY NHÁP** - việc đã xong. Nội dung **không sai**, chỉ hết vai |
> | **Là gì** | Checklist thi công của socket adapter, **100% `[x]`** |
> | **Thiết kế ở** | [`../thiet-ke/06-socket-adapter.md`](../thiet-ke/06-socket-adapter.md) |
> | **Hiện trạng ở** | chính cây mã `xime/adapters/socket/` |
>
